...
function Home() {
  return (
    <div className="min-h-screen bg-background text-foreground">
      <Header />
      <Hero />
      {/* Search filter panel removed for now — re-enable when ready. */}
      {/* <SearchPanel /> */}
      {/* "Popular categories" section removed for now — re-enable when ready. */}
      {/* <Categories /> */}
      <Featured />
      <Benefits />
...
function Hero() {
  return (
    <section className="relative overflow-hidden">
      ...
      />
      <div className="container-page grid gap-16 pb-20 pt-8 lg:grid-cols-[1.05fr_1fr] lg:items-center lg:pb-28 lg:pt-12">
