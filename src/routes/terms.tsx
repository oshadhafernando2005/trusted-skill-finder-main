...
function Terms() {
  return (
    <StaticPageLayout title="Terms of Service" subtitle="Last updated: 2026">
      ...
      <p>
        You must be able to form a legally binding contract to use the Platform. If you're booking
        on behalf of someone else or a business, you confirm you're authorized to do so.
      </p>

      <h2 className="text-2xl font-display text-foreground">2. Professional listings</h2>
      <p>
        Each professional listed on the Platform is responsible for the accuracy of the information
        in their profile, including their qualifications, experience, rates and availability.
        Booking Pro reviews profiles before they become publicly visible, but a listing on the
        Platform is not a guarantee or certification of a professional's qualifications by Booking
        Pro.
      </p>
      ...
      <p>
        ...
        processed through our third-party payment provider. Cancellation and refund terms may vary
        by professional — please check the details on a professional's profile or contact them
      ...
      <ul className="list-disc space-y-2 pl-6">
        <li>Provide false or misleading information when creating an account or booking</li>
      ...
      <p>
        We may suspend or terminate access to the Platform for any account that violates these Terms
        or that we reasonably believe poses a risk to other users.
      </p>

      <h2 className="text-2xl font-display text-foreground">6. Disclaimers</h2>
      <p>
        Booking Pro is a marketplace connecting clients and professionals. We are not a party to the
        service relationship between a client and a professional, and we are not responsible for the
        quality, safety, or legality of services provided by professionals on the Platform.
      </p>
